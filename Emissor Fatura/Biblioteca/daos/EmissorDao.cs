...
{
    internal class EmissorDao : EntidadeDao
    {
        private string caminhoArquivo = Constante.PathData(Tipo.EMISSOR);
        ...
        {
            return Leitura.Read(Tipo.EMISSOR).Select(o => JsonConvert.DeserializeObject<Cliente>(Decode(o)))
                                               .OrderBy(o => o.Nome)
                                               .ToList();
        }
